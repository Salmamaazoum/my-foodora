...
public class AppTest {
	public static void main(String[] args) {
		...
		// Login Manager
		System.out.print(appSystem.login("Salma", "1234"));
		...
		System.out.print(manager1.addNewUser(customer1));
		...
		System.out.print(manager2.addNewUser(customer2));
		System.out.println(appSystem.getCustomers().get(1));
		
		// Login customer 1
		System.out.print(appSystem.login("Layla1", "1234"));
